        ...
        rules: [
            ...
            },
            {
                validateFunction: function (rule, value, data, callback) {
                    // let baseConfig: any = localStorage.getItem('baseConfig')
                    // baseConfig = baseConfig ? JSON.parse(baseConfig) : null
                    // if (baseConfig) {
                    //     let langId = baseConfig.languages[0].id
                    //     let validate = isPhone(value, langId)
                    //     if (!validate) {
