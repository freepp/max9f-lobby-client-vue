...
<script lang="ts" setup>
  ...
  const getSignInData = async () => {
      ...
      let res = await activityApi.signin.signinLoadCreate(params)
      if (res.success) {
  ...
  const execute = async (item, type) => {
      ...
      let res = await activityApi.signin.signinExecuteCreate(params)
