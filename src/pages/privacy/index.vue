    ...
    <Layout :hasHeader="false">
        ...
        <view class="scroll-view">
            <view class="faq-view">
                ...
                <!-- <view class="title">{{ $t('KEY_FAQ_TITLE') }}</view> -->
                ...
                <view class="content-view">
                    <!-- <view
                        class="secition"
                        v-html="$t('KEY_FAQ_CONTENT')"
                    ></view> -->
                    <view
                        id="secition1"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION1')"
                    ></view>
                    <view
                        id="secition2"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION2', {domain: domain })"
                    ></view>
                    <view
                        id="secition3"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION3', {domain: domain})"
                    ></view>
                    <view
                        id="secition4"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION4')"
                    ></view>
                    <view
                        id="secition5"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION5', {domain: domain})"
                    ></view>
                    <view
                        id="secition6"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION6')"
                    ></view>
                    <view
                        id="secition7"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION7', {domain: domain})"
                    ></view>
                    <view
                        id="secition8"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION8')"
                    ></view>
                    <view
                        id="secition9"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION9')"
                    ></view>
                    <view
                        id="secition10"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION10')"
                    ></view>
                    <view
                        id="secition11"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION11', {domain: domain})"
                    ></view>
                    <view
                        id="secition12"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION12')"
                    ></view>
                    <view
                        id="secition13"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION13')"
                    ></view>
                    <view
                        id="secition14"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION14')"
                    ></view>
                    <view
                        id="secition15"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION15')"
                    ></view>
                    <view
                        id="secition16"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION16')"
                    ></view>
                    <view
                        id="secition17"
                        class="secition"
                        v-html="$t('KEY_PRIVACY_SECITION17', {domain: domain})"
                    ></view>
                </view>
            </view>
        </view>
